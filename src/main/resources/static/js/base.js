 ...
 * @param options
 */
$.dodo.prototype.alertOk = function (options) {
 ...
 * @param text
 */
$.dodo.prototype.alertOkAndReload = function (text) {
 ...
 * @param options
 */
$.dodo.prototype.alertWarn = function (options) {
    options = options.length ? {text:options} : ( options || {} );
 ...
 * @param options
 */
$.dodo.prototype.alertConfirm = function (options) {
    options = options || {};
 ...
 * @param options
 */
$.dodo.prototype.alertError = function (options) {
    options = options.length ? {text:options} : ( options || {} );
 ...
 * @param options
 */
$.dodo.prototype.alertBox = function (options) {
    swal({
        title: options.title,
        text: options.text,
        type: options.type,
 ...
 * @param options   参数
 */
$.dodo.prototype.post = function (options) {
    var self = this;
    $.ajax({
        type: 'POST',
        url: options.url,
 ...
 * 显示动画
 */
$.dodo.prototype.showLoading = function () {
 ...
 * 隐藏动画
 */
$.dodo.prototype.hideLoading = function () {
